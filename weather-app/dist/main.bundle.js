...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _weather_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weather-data */ \"./src/app/weather-data.js\");\n\r\n\r\n// Import module that will make calls\r\n// Call function that starts app (makes first call)\r\n\r\nconst weatherModule = (0,_weather_data__WEBPACK_IMPORTED_MODULE_0__.weatherData)();\r\n\n\n//# sourceURL=webpack://weather-app/./src/app/app.js?");

/***/ }),

/***/ "./src/app/utils/api-calls/current-weather.js":
/*!****************************************************!*\
  !*** ./src/app/utils/api-calls/current-weather.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"weatherData\": () => (/* binding */ weatherData)\n/* harmony export */ });\n/* harmony import */ var _utils_api_calls_current_weather__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/api-calls/current-weather */ \"./src/app/utils/api-calls/current-weather.js\");\n/* harmony import */ var _weather_class_current_weather_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weather-class/current.weather.class */ \"./src/app/weather-class/current.weather.class.js\");\n\r\n\r\n\r\nconst weatherData = () => {\r\n  const getCurrentWeather = async (city, unit, state = \"\") => {\r\n    console.log(await (0,_utils_api_calls_current_weather__WEBPACK_IMPORTED_MODULE_0__.currentWeatherCall)(city, unit, state));\r\n  };\r\n\r\n  getCurrentWeather(\"Dallas\", \"metric\", \"TX\");\r\n\r\n  return {\r\n    getCurrentWeather,\r\n  };\r\n};\r\n\n\n//# sourceURL=webpack://weather-app/./src/app/weather-data.js?");
